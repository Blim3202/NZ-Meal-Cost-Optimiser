...
export default {
  setup() {
    ...
    return { addressHistory, companies, dishes, error, expandedStores, filteredRows, filteredStoreCosts, form, formatDate, companyLabel, badgeClass, loading, money, pack, recipe, result, rowCompany, rowSort, runOptimise, statusClass, storeKey, storeSort, toggleStore, unitPrice, usedPrice };
  }
};
</script>
