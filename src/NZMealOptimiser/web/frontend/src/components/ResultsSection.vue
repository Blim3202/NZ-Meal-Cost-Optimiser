...
export default {
  ...
  setup(props) {
    ...
    return { expandedStores, storeSort, excluded, textFilters, numSortKey, numSortDir, openFilter, catLabels, catOptions, filteredRows, filteredStoreCosts, resetFilters, focusStore, toggleCat, shownCount, toggleOpen, flipDir, toggleStore, storeKey, money, usedPrice, recipe, pack, unitPrice, companyLabel, badgeClass, statusClass, formatDate };
  },
};
</script>
