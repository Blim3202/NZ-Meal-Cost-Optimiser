...
class TestNewWorldEdgeAPI:
    ...
    @patch("NZMealOptimiser.pricing.newworld_api.requests.get")
    ...
    @patch("NZMealOptimiser.pricing.newworld_api.requests.post")
...
class TestNewWorldMobileAPI:
    ...
    @patch("NZMealOptimiser.pricing.newworld_api.cloudscraper.create_scraper")
