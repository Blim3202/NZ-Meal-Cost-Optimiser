"""
Unit tests for Pak'nSave Mobile Optimiser CLI (paknsave_optimiser_mobile.py).
...
class TestPaknSaveOptimiserMobileCLI:
    ...
    @patch("tools.paknsave.paknsave_optimiser_mobile.foodstuffs_querier_mobile")
    @patch("tools.paknsave.paknsave_optimiser_mobile.optimise")
    def test_main_defaults(self, mock_optimise, mock_query):
        ...
        import tools.paknsave.paknsave_optimiser_mobile as paknsave_optimiser_mobile

        with patch.object(sys, "argv", ["paknsave_optimiser_mobile.py"]):
            paknsave_optimiser_mobile.main()
