...
class TestPaknSaveOptimiserEdgeCLI:
    ...
    @patch("tools.paknsave.paknsave_optimiser_edge.foodstuffs_querier_edge")
    @patch("tools.paknsave.paknsave_optimiser_edge.optimise")
    def test_main_defaults(self, mock_optimise, mock_query):
        ...
        import tools.paknsave.paknsave_optimiser_edge as paknsave_optimiser_edge
