...
class TestFetchStoresFromEdgeAPI:
    ...
    @patch("tools.paknsave.paknsave_setup.get_website_jwt")
    @patch("tools.paknsave.paknsave_setup.requests.get")
...
class TestFetchStoresFromStoreFinder:
    ...
    @patch("tools.paknsave.paknsave_setup.cloudscraper.create_scraper")
...
class TestFetchStoresDispatch:
    ...
    @patch("tools.paknsave.paknsave_setup.fetch_stores_from_edge_api")
    ...
    @patch("tools.paknsave.paknsave_setup.fetch_stores_from_store_finder")
    ...
    @patch("tools.paknsave.paknsave_setup.fetch_stores_from_mobile_api")
