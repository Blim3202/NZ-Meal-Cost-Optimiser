"""
Unit tests for Pak'nSave Edge Optimizer CLI (paknsave_optimizer_edge.py).
...
class TestPaknSaveOptimizerEdgeCLI:
    ...
    def test_main_defaults(self, mock_optimise, mock_query):
        ...
        with patch.object(sys, "argv", ["paknsave_optimizer_edge.py"]):
            paknsave_optimizer_edge.main()
