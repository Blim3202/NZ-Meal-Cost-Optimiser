...
class TestFetchStoresFromEdgeAPI:
    ...
    @patch("newworld_setup.get_website_jwt")
    @patch("newworld_setup.requests.get")
...
class TestFetchStoresFromMobileAPI:
    ...
    @patch("newworld_setup.cloudscraper.create_scraper")
...
class TestFetchStoresDispatch:
    ...
    @patch("newworld_setup.fetch_stores_from_edge_api")
    ...
    @patch("newworld_setup.fetch_stores_from_mobile_api")
    ...
    @patch("newworld_setup.fetch_stores_from_store_finder", create=True)
