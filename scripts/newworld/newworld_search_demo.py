"""
New World NZ Product Search Demo
==================================
Example script demonstrating two-pass product search via the New World Edge API.
Searches for "milk" at New World Albany and prints the top 10 results with
pricing details.
...
Usage:
    python scripts/newworld/newworld_search_demo.py
