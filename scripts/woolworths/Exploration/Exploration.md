...
| `../woolworths_optimizer.py` | Thin CLI: delegates step 1 (geocode → nearby stores → fresh session per store → cookie injection → ingredient search) to `optimizer_utils.woolworths_optimizer`, then step 2 `optimise()` |
